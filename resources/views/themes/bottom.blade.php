        ...
        <div class="fixed-plugin">
          <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="https://material-dashboard-laravel.creative-tim.com/material/img/sidebar-2.jpg" alt="">
                </a>
              </li>
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="https://material-dashboard-laravel.creative-tim.com/material/img/sidebar-3.jpg" alt="">
                </a>
              </li>
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
